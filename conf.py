...
BLOG_AUTHOR = "Leo Arias"  # (translatable)
BLOG_TITLE = "Tangamandapio"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://elopio.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://elopio.net/"
BLOG_EMAIL = "yo@elopio.net"
...
# (translatable)
CONTENT_FOOTER = '{license} - Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a>'
...
PANDOC_OPTIONS = [
    '-F', 'pandoc-citeproc', '--bibliography=bibliography.bibtex']
